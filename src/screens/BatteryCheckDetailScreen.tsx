...
const SHOPS: Shop[] = [
  { id: "bch1", name: "Battery Health Pro", distanceKm: 0.8, rating: 4.5, price: 40, etaMinutes: 25 },
  { id: "bch2", name: "Volt Check Garage", distanceKm: 1.9, rating: 4.2, price: 35, etaMinutes: 30 },
  { id: "bch3", name: "Amp Diagnostics", distanceKm: 3.0, rating: 4.6, price: 45, etaMinutes: 28 },
];

export default function BatteryCheckDetailScreen() {
  ...
  return (
    <div className="flex flex-col w-screen min-h-screen bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
      <header className="bg-white shadow p-4 flex items-center justify-between">
        ...
        <h1 className="text-xl sm:text-2xl font-semibold text-gray-800">Battery Check</h1>
        <div className="w-20" />
      </header>
        ...
        <div className="mx-auto max-w-4xl space-y-4">
          <Card>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">Standard vs Premium diagnostics.</p>
              </div>
          ...
          <Card>
            <div className="flex items-center justify-between">
              ...
              <Button disabled={!selectedShop} onClick={() => selectedShop && navigate("/dashboard/service-category/battery-check/book", { state: { shop: selectedShop, tier } })}>Proceed to Booking</Button>
            </div>
          </Card>
        </div>
      </main>
