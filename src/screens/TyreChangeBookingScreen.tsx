...
export default function TyreChangeBookingScreen() {
  const navigate = useNavigate();
  const { user } = useAuth();
  const location = useLocation();
  const state = (location.state ?? {}) as { shop?: SelectedShop; tier?: "standard" | "premium" };
  ...
  return (
    <div className="flex flex-col w-screen min-h-screen bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
      ...
      <header className="bg-white shadow p-4 flex items-center justify-between">
        ...
        <h1 className="text-xl sm:text-2xl font-semibold text-gray-800">Tyre Change — Booking</h1>
        <div className="w-20" />
      </header>
          ...
          <Card>
            {selectedShop ? (
              ...
              <div className="flex items-center justify-between">
                ...
                <Button onClick={() => navigate("/dashboard/service-category/tyre-change")}>Select Shop</Button>
              </div>
            )}
          </Card>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={form.date}
                    onChange={onChange}
                    className="w-full border rounded-xl px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none border-gray-300"
                    required
                  />
                </div>
                <div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full border rounded-xl px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none border-gray-300 min-h-[80px]"
                  />
                </div>
              </div>
            </Card>
