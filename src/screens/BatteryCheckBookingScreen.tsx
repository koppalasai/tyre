...
export default function BatteryCheckBookingScreen() {
  ...
  return (
    <div className="flex flex-col w-screen min-h-screen bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
      <header className="bg-white shadow p-4 flex items-center justify-between">
        ...
        <h1 className="text-xl sm:text-2xl font-semibold text-gray-800">Battery Check — Booking</h1>
        <div className="w-20" />
      </header>
          ...
          <Card>
            {selectedShop ? (
              ...
              <div className="flex items-center justify-between">
                ...
                <Button onClick={() => navigate("/dashboard/service-category/battery-check")}>Select Shop</Button>
              </div>
            )}
          </Card>
